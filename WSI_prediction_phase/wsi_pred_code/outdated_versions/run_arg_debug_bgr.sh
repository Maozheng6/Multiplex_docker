...
CODE=ICCV_Train_with_dots_All_Data_newnet_5.7_backweight0.1_newBGR_aug_no_unknown_color-aug0.2_domain-shift_6-7ratio_10wsi-regi_wsi-no-trans
#ICCV_Train_with_dots_All_Data_newnet_5.1_backweight0.1_newBGR_aug_no_unknown_color-aug
SAVE_VISUAL=0
LR=0.1
GPU_ID=6
GPU_USED=7
...
SIGMA_TIMES=1.0
START_STAIN=0
RESIZE_RATIO=0.8448673587081891
TEST=True
...
ITRAIN_PATCH_LIST=maozheng_patch_list_multiplex.txt
...
PRED_OUTPUT=../wsi_prediction/pred_out_O0135_fixbgr_${EPOCH}/${SLIDE}
mkdir -p ${PRED_OUTPUT}

TEST_CSV=O0135_registered_testset.csv
...
#new_dots_test_O0135.csv
#maozhen:g_Multiplex_patch_list_test_2nd_batch.csv
