...
import os
import pandas as pd
input_folder='/scratch/KurcGroup/mazhao/tiles_slide/single_stain/'
...
suffix='_20x10x_comb'
#tiles=['N4277', 'L6745',  'N22034',  'N9430',  'O0135',  'O3936']
...
for tile in tiles:
    ...
    print('wsi_patches_folder',input_folder+tile+'-multires'+'/')
    num_wsi_patches=len(glob.glob(input_folder+tile+'-multires'+'/'+'*png'))#*(8*2+1)
    #number of prediction
    print('pred folder', output_folder+tile+suffix+'/')
