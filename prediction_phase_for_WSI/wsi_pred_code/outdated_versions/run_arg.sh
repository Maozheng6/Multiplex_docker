CODE=ICCV_Train_with_dots_All_Data_newnet_6.1_backweight0.1_newBGR_aug_no_unknown_color-aug0.2_domain-shift_6-7ratio_60wsi-dan
SAVE_VISUAL=0
LR=0.1
GPU_ID=$1
GPU_USED=6
...
python -u test_model_multiplex_1stain_8layer_batchloss_no-softmax_nowhite_resize_fix-shuffle_argmax_visual_argmax-map.py \
        --input=${TEST_CSV} \
        --output=${PRED_OUTPUT}/ \
        --model=${TEST_MODEL} \
        --gpuid=${GPU_ID} \
