...
def main():
    ...
    print(savefolder+'/*8fig.png')
    exist_list=glob.glob(savefolder+'/*8fig.png')
    print(savefolder+'/*8fig.png')
    print('len(exist_list)',len(exist_list))
    name_list=[x[0] for x in pair_list]
    #name_list = list(set(name_list))
    label_list=[x[1] for x in pair_list]
    ...
    for i in range(len(name_list)):
        ...
        #print('len(exist_list)',len(exist_list))
        if savefolder+os.path.basename(naip_fn)[0:-4]+'_8fig.png' in exist_list:
            ...
            count_c+=1
            #print('count_c',count_c,len(name_list),len(exist_list))
        print('count_c',count_c,len(name_list),len(exist_list))
        '''
        print(naip_fn)
