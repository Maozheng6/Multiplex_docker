...
def main():
    ...
    for i in reversed(range(len(pair_list))):
        ...
        for stain_i in range(0,stain_num+1):
            ...
            edges_overlay1=np.clip(edges_overlay+thre_edge,0,255).astype('uint8')
            edges_overlay1=cv2.resize(edges_overlay1,(int(edges_overlay1.shape[1]/4),int(edges_overlay1.shape[0]/4)))
