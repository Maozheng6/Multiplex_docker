#!/bin/Ibash
CODE=Multi_6layer_99_1_Bloss_mb2_ch12_v5_64conv_V2loss_actualloss
#_withBN_yb99.5_yerode1_cyan.75_mustdv3
SAVE_VISUAL=0
LR=0.5
GPU_ID=1
SUPERRES=0.0005
...
OUTPUT=/mnt/blobfuse/train-output/ByMZ/3.18_multi_level/
#/mnt/blobfuse/train-output/ByMZ-train_tumor_MZ1-0_1_1_1_1_1_1_1_1_1_1-2-40
...
TEST_MODEL=/mnt/blobfuse/train-output/ByMZ/3.4batch_loss_le/${EXP_NAME}/cnn_20.model

echo ${TEST_MODEL}

PRED_OUTPUT=/mnt/blobfuse/train-output/ByMZ/3.4batch_loss_le/pred_out/${EXP_NAME}/
...
python -u visualize_dots.py ${PRED_OUTPUT} >${EXP_NAME}-evaluation.txt
'
