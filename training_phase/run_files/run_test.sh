...
CODE=Multi_6layer_99_1_withBN_yb99.5_yerode1_cyan.75_mustdv3_mb24_oriloss
SAVE_VISUAL=0
LR=0.5
GPU_ID=0
SUPERRES=0.0005
...
TEST_MODEL=/mnt/blobfuse/train-output/ByMZ/3.14/${EXP_NAME}/cnn_20.model
echo ${TEST_MODEL}
PRED_OUTPUT=/mnt/blobfuse/train-output/ByMZ/3.14/${EXP_NAME}/pred_out
mkdir -p ${PRED_OUTPUT}
