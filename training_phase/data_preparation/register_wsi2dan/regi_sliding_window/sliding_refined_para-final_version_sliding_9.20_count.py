...
def register_single(img1_ref_bgr, img2_wsi_bgr, out_dir, slide_name, dan_tile_idx,MAX_FEATURES_1,GOOD_MATCH_PERCENT,save_ratio, if_regi):
    ...
    if if_regi != True :
        ...
        cv2.imwrite(os.path.join(out_dir, slide_name+'_'+dan_tile_idx+'_ratio'+ str(save_ratio)+'_dan.png'), img2)
...
if __name__ == '__main__':
    ...
    #output folders
    regi_out_dir = './regi_out_final/'
    slide_results = './middle_results_for_slides/' #'./slide_results_20190603_more_multiplex_labels/'#'./middle_results_for_slides/'
    ...
    #wsi2dan_slide = {'N22800-multires':'N22800_20'}
