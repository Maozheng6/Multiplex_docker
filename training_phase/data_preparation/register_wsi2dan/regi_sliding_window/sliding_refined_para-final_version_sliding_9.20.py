...
#whole slide size
    ...
    resize_ratio=resolution_control*0.3468/0.293
...
if __name__ == '__main__':
    ...
    GOOD_MATCH_PERCENT_ROUGH =0.5 #0.15
    # parameters for fine registration

    level_fine = 0
    MAX_FEATURES_FINE = 4000
    GOOD_MATCH_PERCENT_FINE =0.10 #0.30

    resolution_control = 0.5

    #output folders
    regi_out_dir = './regi_out_final_all_2ndpass/'
    slide_results = './middle_results_for_slides_all_2ndpass/' #'./slide_results_20190603_more_multiplex_labels/'#'./middle_results_for_slides/'
    ...
    cropped_save_folder = './cropped_imgs_wd2_st_1_all_2ndpass/'
    ...
    input_df = pd.read_csv('wsi_dan_map_second_pass.csv')
    ...
    #wsi2dan_slide = {'L6745-multires':'L6745_0','O0135-multires':'O0135_95','O3936-multires':'O3936_2'}
    #wsi2dan_slide = {'3908-multires':'N3908_70', 'O6218_MULTI_3-multires':'O6218_30'}
    #wsi2dan_slide = {'N24178-multires':'N24178_80'}
    ######################################
    count_p =0
    ...
    for slide_name in wsi2dan_slide.keys():
        ...
        for file_i in files:
            ...
            dan_on_wsi_size = (np.array(size_dan)*0.293/(0.3468*resolution_control)).astype(int)
            ...
            ref_img_level = cv2.resize(ref_img,(int((ref_img.shape[1]*0.293/(0.3468*resolution_control))/(2**level)),int((ref_img.shape[0]*0.293/(0.3468*resolution_control))/(2**level))))
