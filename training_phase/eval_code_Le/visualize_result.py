...
Image.fromarray(np.load(GT)[..., :3]).save('image.png')
Image.fromarray(pred_rgb).save('pred.png')
Image.fromarray(pred_lab_rgb).save('pred_label.png')

Image.fromarray(np.concatenate((np.load(GT)[..., :3], pred_lab_rgb), axis=0)).save('im_pred_label.png')
