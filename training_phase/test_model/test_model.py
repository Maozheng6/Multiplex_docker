...
def run_model_on_tile(model, naip_tile, inpt_size, batch_size):
...
def main():
    ...
    for i in range(len(pair_list)):
        ...
        output = run_model_on_tile(model, naip_tile.astype(np.float32)/255.0, model_input_size, 32)
        ...
        output_classes.save('./tumor_sup/'+os.path.basename(naip_fn))
